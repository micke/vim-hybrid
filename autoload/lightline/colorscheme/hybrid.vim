...
" Common colors
let s:fg     = [ '#585c63', 145 ]
let s:blue   = [ '#81a2be', 75 ]
let s:green  = [ '#b5bd68', 76 ]
let s:purple = [ '#b294bb', 176 ]
let s:red1   = [ '#cc6666', 168 ]
let s:red2   = [ '#5f0000', 168 ]
let s:yellow = [ '#f0c674', 180 ]

let s:p = {'normal': {}, 'inactive': {}, 'insert': {}, 'replace': {}, 'visual': {}, 'tabline': {}}

let s:bg     = [ '#1d1f21', 234 ]
let s:gray1  = [ '#c5c8c6', 250 ]
let s:gray2  = [ '#9e9e9e', 235 ]
