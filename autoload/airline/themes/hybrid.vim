...
" Based On: https://github.com/w0ng/vim-hybrid and https://github.com/morhetz/hybrid
" License: MIT
" -----------------------------------------------------------------------------
...
function! airline#themes#hybrid#refresh()
  ...
  let g:airline#themes#hybrid#palette.normal_modified = { 'airline_c': modified_group }
  ...
  let g:airline#themes#hybrid#palette.normal.airline_error = error_group
  let g:airline#themes#hybrid#palette.normal_modified.airline_error = error_group
  ...
  let g:airline#themes#hybrid#palette.replace_modified.airline_warning = g:airline#themes#hybrid#palette.normal_modified.airline_warning
  let g:airline#themes#hybrid#palette.replace.airline_error = g:airline#themes#hybrid#palette.normal.airline_error
  let g:airline#themes#hybrid#palette.replace_modified.airline_error = g:airline#themes#hybrid#palette.normal_modified.airline_error
  ...
  let g:airline#themes#hybrid#palette.visual_modified = { 'airline_c': [ s:V3[0], '', s:V3[2], '', '' ] }
  ...
  let g:airline#themes#hybrid#palette.visual_modified.airline_error = g:airline#themes#hybrid#palette.normal_modified.airline_error
  ...
  let g:airline#themes#hybrid#palette.inactive_modified = { 'airline_c': modified_group }

  let g:airline#themes#hybrid#palette.accents = { 'red': accents_group }
